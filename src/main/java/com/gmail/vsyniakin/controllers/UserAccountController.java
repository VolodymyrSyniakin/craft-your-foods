...
public class UserAccountController {
    ...
    public String accModeratorSearchRecipe(@RequestParam String name, @ModelAttribute UserAccount userAccount, ModelMap modelMap) {
    ...
    public String accModeratorSearchMessage(@RequestParam String text, @ModelAttribute UserAccount userAccount, Model model) {
        model.addAttribute("view", MODERATOR_PAGE);
        model.addAttribute("userAcc", userAccount);
    ...
    public String changePassword(@RequestParam String pass, @RequestParam String repeat, @ModelAttribute UserAccount userAccount) {
