...
public class UserDataDAOImpl implements UserDataDAO {
	...
	public UserData getByEmail(String email) {
		TypedQuery<UserData> query = entityManager.createQuery("SELECT u FROM UserData u WHERE u.email = :email",
				UserData.class);
	...
	public UserData getById(long id) {
		TypedQuery<UserData> query = entityManager.createQuery("SELECT u FROM UserData u WHERE u.id = :id",
				UserData.class);
	...
	public String getEmailByUserAccount(UserAccount userAccount) {
		TypedQuery<String> query = entityManager
				.createQuery("SELECT u.email FROM UserData u WHERE u.userAccount = :userAccount", String.class);
